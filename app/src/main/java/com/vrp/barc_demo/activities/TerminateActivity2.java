...
public class TerminateActivity2 extends AppCompatActivity {
    ...
    @BindView(R.id.rb_household_size)
    RadioButton rb_household_size;
    @BindView(R.id.rb_highest_education)
    RadioButton rb_highest_education;
    @BindView(R.id.rb_ine_mosr)
    RadioButton rb_ine_mosr;
    @BindView(R.id.rb_ine_dth)
    RadioButton rb_ine_dth;
    @BindView(R.id.rb_ine_language)
    RadioButton rb_ine_language;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle!=null) {
            ...
            screen_id=bundle.getString("screen_id", "");
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                switch (i) {
                    ...
                    case R.id.rb_in_eligible_nccs:
                        ...
                        rb_door_lock.setError(null);
                        break;
                    case R.id.rb_household_size:
                        reason=getResources().getString(R.string.household_size);
                        halt_radio_button_id="7";
                        til_name.setVisibility(View.GONE);
                        til_address.setVisibility(View.GONE);
                        til_comment.setVisibility(View.VISIBLE);
                        rb_household_size.setError(null);
                        break;
                    case R.id.rb_highest_education:
                        reason=getResources().getString(R.string.highest_education);
                        halt_radio_button_id="8";
                        til_name.setVisibility(View.GONE);
                        til_address.setVisibility(View.GONE);
                        til_comment.setVisibility(View.VISIBLE);
                        rb_highest_education.setError(null);
                        break;
                    case R.id.rb_ine_mosr:
                        reason=getResources().getString(R.string.ine_mosr);
                        halt_radio_button_id="9";
                        til_name.setVisibility(View.GONE);
                        til_address.setVisibility(View.GONE);
                        til_comment.setVisibility(View.VISIBLE);
                        rb_ine_mosr.setError(null);
                        break;
                    case R.id.rb_ine_dth:
                        reason=getResources().getString(R.string.ine_dth_connection);
                        halt_radio_button_id="10";
                        til_name.setVisibility(View.GONE);
                        til_address.setVisibility(View.GONE);
                        til_comment.setVisibility(View.VISIBLE);
                        rb_ine_dth.setError(null);
                        break;
                    case R.id.rb_ine_language:
                        reason=getResources().getString(R.string.ine_langauage);
                        halt_radio_button_id="11";
                        til_name.setVisibility(View.GONE);
                        til_address.setVisibility(View.GONE);
                        til_comment.setVisibility(View.VISIBLE);
                    ...
                    if (checkValidationHalt()) {
                        ...
                        try {
                            try {
                                ...
                                json_object.put("description", et_comment.getText().toString().trim());
                   ...
                   /* String listString = gson.toJson(
                    ...
                    try {
                        try {
                            ...
                            if (halt_radio_button_id.equals("6")) {
                                json_object.put("termination_reason", "Quota Termination");
                                    ...
                                    ||halt_radio_button_id.equals("4")||halt_radio_button_id.equals("7")
    ...
    private boolean checkValidation() {
        ...
        else if (halt_radio_button_id.equals("12")){
            if (et_name.getText().toString().trim().length()==0) {
                til_name.setError("Please enter name!");
                return false;
            } else {
